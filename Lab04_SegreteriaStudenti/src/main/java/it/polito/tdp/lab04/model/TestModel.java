...
public class TestModel {
	...
	public static void main(String[] args) {
		...
		for (Studente s : model.studentiIscrittiAlCorso(new Corso("02AQJPG",null,0,0))) {
		...
		// Punto 4
		sb = new StringBuilder();
		for (Corso corso : model.cercaCorsiDatoStudente(new Studente(146101,null,null,null))) {
			sb.append(String.format("%-8s ", corso.getCodins()));
			sb.append(String.format("%-2s ", corso.getCrediti()));
			sb.append(String.format("%-50s ", corso.getNome()));
			sb.append(String.format("%-4s ", corso.getPd()));
		...
		// Punto 5
		boolean result = model.isStudenteIscrittoACorso(new Studente(146101,null,null,null), new Corso("01NBAPG",null,0,0));
		System.out.println(result);
		
		// Punto 6
		model.inscriviStudenteACorso(new Studente(146101,null,null,null), new Corso("01NBAPG",null,0,0));
